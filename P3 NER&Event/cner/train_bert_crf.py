...
from layers.bert_ner import BertCrfNER
...
def eval(model, data):
    ...
    with torch.no_grad():
        for batch in utils.batch_iter_tagging(data, conf.batch_size, False):
            ...
            preds = model.crf.decode(logits, mask_batch)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='config/resume.crf.json')
    ...
    # In crf.py, the "[START]" and "[END]" tags are added.
